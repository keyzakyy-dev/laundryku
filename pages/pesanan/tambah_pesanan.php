...
if (isset($_POST['simpan'])) {
    ...
    if ($berat_kg <= 0) {
        ...
        $query_detail = mysqli_query($koneksi, "
            ...
            (id_detail, id_pesanan, id_layanan, berat_kg)
            VALUES (
                '$id_detail',
                '$id_pesanan',
                '$id_layanan',
...
<div class="container">
    ...
    <div class="form-container modern-form">
        ...
        <div class="form-header">
            ...
            <p>Lengkapi data transaksi laundry dengan benar.</p>
        </div>
        ...
        <form method="POST">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="id_layanan" id="layanan" required>
...
function hitungTotal() {
    let harga = layanan.options[layanan.selectedIndex].getAttribute('data-harga');
    let beratKg = parseFloat(berat.value);

    if (beratKg <= 0) {
        total.value = "";
        berat.setCustomValidity('Berat cucian harus lebih dari 0 kg');
        return;
    }

    berat.setCustomValidity('');
...
<?php if ($notif == "invalid") { ?>

<script>
Swal.fire({
    icon: 'warning',
    title: 'Data tidak valid!',
    text: 'Berat cucian tidak boleh minus atau 0 kg',
    customClass: {
